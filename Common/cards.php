...
">
			<h1>FACULTIES</h1>
			<p>SRM serves the national and international community through a broad spectrum of undergraduate studies..</p>
			<div class="row pt-3 pb-3">
				<div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
					<div class="card card-margin">
						<div class="card-logo m-auto">
							<img src="images/card1.jpg" class="card-img img-fluid">
						</div>
						<div class="card-body">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
					<div class="card card-margin">
						<div class="card-logo m-auto mt-1">
							<img src="images/card2.jpg" class="card-img img-fluid">
						</div>
						<div class="card-body">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
					<div class="card card-margin">
						<div class="card-logo m-auto">
							<img src="images/card3.jpg" class="card-img img-fluid">
						</div>
						<div class="card-body">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
					<div class="card card-margin">
						<div class="card-logo m-auto">
							<img src="images/card4.jpg" class="card-img img-fluid">
						</div>
						<div class="card-body">
