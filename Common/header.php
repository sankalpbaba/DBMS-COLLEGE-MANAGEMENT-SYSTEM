...
<html>
<head>
	<title>WELCOME TO SRM PORTAL</title>
	<link rel="shortcut icon" href="./Images/srm_logo.png" type="image/x-icon">
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="images/srmlogo.png" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">SRM College</h3>
	</a>
